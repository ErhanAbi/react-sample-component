...
var EXAMPLE = React.createClass({
	 ...
	 *
	 * React@0.13.0 breaking change:
	 * Calls to setState in life-cycle methods are now always batched
	 * and therefore asynchronous
	 *
	 * React@0.13.0 new feature:
	 * this.setState() can now take a function as the first argument for transactional
	 * state updates, such as this.setState((state, props) => ({count: state.count + 1}));
	 * – this means that you no longer need to use this._pendingState, which is now gone.
	 */
	 ...
	 *
	 * from React@0.13.0:
	 * @deprecated while still available on createClass-based component creation,
	 *             this method was either removed or deprecated when using
	 ...
	 * @deprecated while still available on createClass-based component creation,
	 *             this method was either removed or deprecated when using
	 *             ES6 class declaration syntax. Use instead React.findDOMNode(component)
	 *
	 * @return DOMNode
	 */
	getDOMNode: function() {},
